...
class Bdd {
    ...
    private static $login = "aravaudet";   // login utilisateur de la BDD
    private static $mdp = "GrmN385B";         // mdp  utilisateur de la BDD
    private static $bd = "aravaudet_resto2";          // nom de la BDD
    private static $serveur = "10.15.253.250";  // nom de domaine du serveur de BDD
